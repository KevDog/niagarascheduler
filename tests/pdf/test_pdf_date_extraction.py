...
class TestPDFDateExtraction(unittest.TestCase):
    ...
    def test_extract_first_day_classes(self):
        ...
        from pdf.date_parser import extract_first_day_from_pdf_text
    ...
    def test_extract_last_day_classes(self):
        ...
        from pdf.date_parser import extract_last_day_from_pdf_text
    ...
    def test_extract_no_class_dates(self):
        ...
        from pdf.date_parser import extract_no_class_dates_from_pdf_text
