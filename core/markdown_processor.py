...
def generate_syllabus_markdown(schedule_data, semester, year, course_id=None, include_description=False, **kwargs):
    ...
    replacements = {
        ...
        'OFFICE_HOURS': kwargs.get('office_hours', 'Office hours will be announced.'),
        'OFFICE_LOCATION': kwargs.get('office_location', 'Office location will be announced.'),
        'EMAIL_ADDRESS': kwargs.get('email_address', 'Email will be provided.'),
        'PHONE_NUMBER': kwargs.get('phone_number', 'Phone number will be provided.'),
